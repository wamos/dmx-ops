...
b_dma_pcie = [dma_time("pcie", data_size, 1, pci_gen, cpu_vendor), dma_time("pcie", data_size, 5, pci_gen, cpu_vendor), dma_time("pcie", data_size, 10, pci_gen, cpu_vendor), dma_time("pcie", data_size, 15, pci_gen, cpu_vendor)]
...
b_dmx_pcie = [dmx_time, dmx_time, dmx_time, dmx_time]  
b_dmx_acc  = [dmx_time, dmx_time, dmx_time, dmx_time]

dmx_exec = [b_dmx_cpu, b_dmx_pcie, b_dmx_acc]
dmx_exec = np.array(dmx_exec)
dmx_exec = dmx_exec.flatten()

data_movement = [b_dma_cpu, b_dma_pcie, b_dma_acc]
